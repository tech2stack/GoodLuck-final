...
router.route('/')
    ...
    .get(authMiddleware.protect, authMiddleware.restrictTo('super_admin', 'branch_admin','stock_manager'), branchController.getAllBranches);

router.route('/:id')
    .get(authMiddleware.protect, authMiddleware.restrictTo('super_admin', 'branch_admin','stock_manager'), branchController.getBranch)
